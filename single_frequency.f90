...
! Proracun tranzijentnog potencijala u jednoj tocki viseslojnog sredstva za 
! jednu (bilo koju) frekvenciju. Ova subroutina sadrzi sve sto je potrebno za 
! proracunati vrijednost tranzijentnog potencijala u bilo kojoj tocki vise-
! slojnog sredstva za bilo koju frekvenciju. Ovu subroutinu koristi se za
! proracun nemoduliranog potencijala (transfer funkcije) tranzijentnog poten-
! cijala u nekoj tocki viseslojnog sredstva zadanog uzemljivackog sustava.
...
!   2) Formira se ukupna matrica admitanciju uzemljivackog sustava pri danoj
...
!      cijala lokalnih cvorova segmenata uzemljivaca.
!   8) Racuna se tranzijentni potencijal u jednoj tocki viseslojnog sredstva, na
!      datoj frekvenciji, pozivom subroutine: potencijal_tocke.


subroutine single_frequency(N,ro,epsr,Ns,Nsi,Nc,Ni,Ii,mirv,sigmav,r0,f,L,HD,h,iso,&
